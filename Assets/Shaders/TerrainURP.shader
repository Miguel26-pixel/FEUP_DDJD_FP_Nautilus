    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct Varyings
            {
                ...
                nointerpolation half3  normalWS                 : TEXCOORD3;

#if _NORMALMAP
                nointerpolation half3 tangentWS                 : TEXCOORD4;
            ...
            Varyings LitPassVertex(Attributes input)
            {
                ...
                // half3 normal = normalize( cross( ddy(vertexInput.positionWS), ddx( vertexInput.positionWS )));
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                // below with your own.
                BRDFData brdfData;
                InitializeBRDFData(vertex_color, surfaceData.metallic, surfaceData.specular, surfaceData.smoothness, surfaceData.alpha, brdfData);
